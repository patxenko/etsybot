    ...
    def get_reviews(self):
        try:
            ...
            if 'output' in jsondata_reviews:
                ...
                print(
                    str(jsondata_reviews) + " para listing" + str(self.data_listing_id) + " shop " + str(
                        self.data_shop_id))
            ...
            print("Error in reviews shop " + str(self.data_shop_id) + " listing " + str(
                self.data_listing_id) + " because " + str(er))
            self.error = True
            return 0
